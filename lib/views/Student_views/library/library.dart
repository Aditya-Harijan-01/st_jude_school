...
import 'package:st_jude_school/providers/student/library_details.dart';
...
class _LibraryScreenState extends State<LibraryScreen> {
  ...
  Future<void> _fetchLibraryData() async {
    final provider = Provider.of<LibraryDetailsProvider>(
      context,
      listen: false,
    );
    final authProvider = Provider.of<AuthProvider>(context, listen: false);
    await provider.getLibraryData(authProvider.loginData!.regno);
  }
