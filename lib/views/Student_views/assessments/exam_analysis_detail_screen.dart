...
import '../attendance/widgets/tree_line_from_DS_report.dart';
import 'widgets/analysis_shimmer.dart';
import 'widgets/subject_analysis_chart.dart';

class ExamAnalysisDetailScreen extends StatefulWidget {
  final String examId;
  final String examName;
  final String toYear;
  final String fromYear;

  const ExamAnalysisDetailScreen({
    super.key,
  ...
  @override
  State<ExamAnalysisDetailScreen> createState() =>
      _ExamAnalysisDetailScreenState();
}

class _ExamAnalysisDetailScreenState extends State<ExamAnalysisDetailScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _fetchExamAnalysis() async {
    try {
      ...
      final analysisProvider =
          Provider.of<StudentsAnalysisByExaminationProvider>(
            context,
            listen: false,
          );
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SubjectAnalysisChart(
                            subjectAnalysisData:
                                analysisProvider.getSubjectAnalysis() ?? [],
                          ),
                          SizedBox(height: 20.h),
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return _buildSubjectCard(
                                analysisProvider.subjectData[index],
                                analysisProvider,
                              );
                            },
                          ),
  ...
  Widget _buildSubjectCard(
    SubjectAnalysisData subject,
    StudentsAnalysisByExaminationProvider analysisProvider,
  ) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          InkWell(
            onTap: hasGroups
                ? () => analysisProvider.toggleSubjectExpansion(subject.aggrId)
                : null,
      ...
      child: Column(
        ...
        children: [
          CircleAvatar(
            ...
            child: Icon(icon, size: 22.sp, color: CustomColor.primaryColor),
          ),
