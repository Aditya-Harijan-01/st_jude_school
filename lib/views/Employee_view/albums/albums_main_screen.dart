...
import '../../Student_views/albums/albums_detail_screen.dart';
import '../../Student_views/albums/widgets/event_card.dart';
import '../../../providers/auth_provider/auth_provider.dart';
import 'widgets/loader.dart';

class AlbumsMainScreenEmp extends StatefulWidget {
  const AlbumsMainScreenEmp({super.key});

  @override
  State<AlbumsMainScreenEmp> createState() => _AlbumsMainScreenState();
}

class _AlbumsMainScreenState extends State<AlbumsMainScreenEmp> {
  @override
  void initState() {
    super.initState();
