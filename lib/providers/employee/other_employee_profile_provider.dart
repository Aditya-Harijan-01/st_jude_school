...
class OtherEmployeeProfileProvider extends ChangeNotifier {
  ...
  Future<bool> getEmployeeProfile(empId) async {
    ...
    try {
      ...
      log("Get other employee profile data error: $e");
      isLoading = false;
      notifyListeners();
      return false;
    }
  ...
  void clearEmployeeProfileData() {
    ...
    notifyListeners();
    if (kDebugMode) {
      log("Other employee profile data cleared successfully");
    }
  }
